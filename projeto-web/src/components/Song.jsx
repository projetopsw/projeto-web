...
export default function Song({ song }) {
    ...
    const likedSongsPlaylist = userPlaylistsDetail.find(p => p.id === LIKED_SONGS_ID);
    const isLiked = likedSongsPlaylist?.songs?.includes(songId) || false;
    ...
    const menuOptions = [
        // Ajustamos a action para passar o target do evento
        { icon: <AddIcon fontSize="small" />, label: 'Adicionar à playlist', action: (e) => handleAddPlaylistClick(e), requiresEvent: true },
    ...
    return (
        <>
                    ...
                    <MenuItem
                        ...
                        onClick={(e) => {
                            if (option.requiresEvent) {
                                // Se for 'Adicionar à playlist', passa o elemento para ser o âncora do menu pop-up.
                                // Usamos e.currentTarget para obter a referência correta do elemento clicado.
            ...
            <Menu
                ...
                // O anchorEl agora é o elemento que foi passado de handleAddPlaylistClick
