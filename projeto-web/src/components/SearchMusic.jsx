// src/components/SearchMusicLocal.jsx

import React, { useState, useEffect, useMemo } from 'react';
import { InputBase, Box, styled, IconButton, List, ListItem, ListItemText, Typography, CircularProgress } from '@mui/material';
...
// ----------------------------------------------------
// FUNÇÕES AUXILIARES (Reutilizadas do Pesquisa.jsx)
// ----------------------------------------------------
...
function SearchMusicLocal({ onSongSelect }) {
    ...
    useEffect(() => {
        const fetchAllSongs = async () => {
            setIsLoading(true);
            try {
                // Buscando a lista de músicas do db.json (endpoint /topSongs)
    ...
    // Evita que a tecla Enter submeta formulário ou navegue
    ...
    // Função de callback local para adicionar a música
