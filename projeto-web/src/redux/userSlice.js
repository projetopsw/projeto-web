...
// ... (todo o seu código de loadUserFromStorage e saveUserToStorage permanece inalterado)
...
// 1. Exportação das actions (correta)
export const { setUserData, updateProfile, logoutUser } = userSlice.actions;

// 2. ADIÇÃO E EXPORTAÇÃO DO SELETOR 👈 MUDANÇA NECESSÁRIA
// Ele pega o estado raiz (state) e retorna o objeto do usuário (state.user.user)
export const selectUser = (state) => state.user.user;

// 3. Exportação do reducer (correta)
