    ...
    try {
        ...
        if (state && state.currentSong) {
            return {
                ...
                queueIndex: state.queueIndex !== undefined ? state.queueIndex : -1,
                isPlaying: state.isPlaying !== undefined ? state.isPlaying : false,
                volume: state.volume !== undefined ? state.volume : 0.5,
                isShuffling: state.isShuffling !== undefined ? state.isShuffling : false,
                repeatMode: state.repeatMode !== undefined ? state.repeatMode : REPEAT_MODES.OFF,
            };
        }
        return undefined;
    } catch (e) {
