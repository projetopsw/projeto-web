// userSlice.js (CÓDIGO FINAL COM CORREÇÕES DE CONSISTÊNCIA)
...
    try {
        // CORREÇÃO: Salva o objeto completo no localStorage 'loggedUser'
        // Se este slice for usado para perfis (como parece ser), ele não deve filtrar.
...
            if (state.user) {
                // CORREÇÃO DE CONSISTÊNCIA: Pega o role do authSlice para garantir que ele não seja perdido
