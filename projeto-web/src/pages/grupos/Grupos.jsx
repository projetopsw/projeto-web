      ...
      <Box className="conteudo-baixo" sx={{ padding: '15px' }}>
        ...
        <Button
          ...
          sx={{
            ...
            fontWeight: 'bold',
            '&:hover': {
              backgroundColor: buttonBg === '#666' ? '#666' : 'var(--darker-orange)',
            },
          }}
        >
          {buttonText}
  ...
  if (isLoading || !currentUserId) {
    return (
      <main className="content-area" style={{ paddingTop: '50px', textAlign: 'center' }}>
        ...
        <Typography sx={{ color: 'var(--text-color)', marginTop: '10px' }}>
          Carregando Grupos...
        </Typography>
      </main>
    );
    ...
    <main className="content-area">
      ...
      <Box sx={{ display: isFormVisible ? 'none' : 'block' }}>
        <Box className="meus-grupos">
          <Typography
            variant="h5"
            component="h2"
            sx={{ marginBottom: '15px', color: 'var(--secondary-text-color)' }}
          >
      ...
      >
        <Typography
          variant="h5"
          component="h2"
          sx={{ marginBottom: '20px', color: 'var(--text-color)' }}
        >
          Criar novo grupo
        </Typography>
        <form onSubmit={handleCreateGroup}>
          <Typography
            component="label"
            htmlFor="nome-grupo"
            sx={{ display: 'block', mt: 2, color: 'var(--secondary-text-color)' }}
          >
            Nome do Grupo *
          </Typography>
          <CustomTextField
